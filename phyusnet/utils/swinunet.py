...
class parser:
        def __init__(self):
            self.root_path = "../data/Synapse/train_npz"
            ...
            self.img_size = 224
            self.seed = 1234
            self.cfg = "./utils/swinunet_cfg_file.yaml"
            self.opts = None
            self.zip = False
...
if __name__ == "__main__":
    ...
    # parser.add_argument("--cfg", type=str, default="./utils/swinunet_cfg_file.yaml")
    ...
    model = SwinUnet(config=config).to(torch.device("cuda:0"))
